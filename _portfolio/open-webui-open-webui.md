...
![Open WebUI Banner](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/open-webui-open-webui/banner.png)

**Open WebUI is an [extensible](https://docs.openwebui.com/features/plugin/), feature-rich, and user-friendly self-hosted AI platform designed to operate entirely offline.** It supports various LLM runners like **Ollama** and **OpenAI-compatible APIs**, with **built-in inference engine** for RAG, making it a **powerful AI deployment solution**.

Passionate about open-source AI? [Join our team →](https://careers.openwebui.com/)

![Open WebUI Demo](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/open-webui-open-webui/demo.png)
