...
But it also can be easily built with Visual Studio and [libSDL2 development libraries](https://www.libsdl.org/release/SDL2-devel-2.32.2-VC.zip) installed.
...
| javascript       | ✓       | [typescript-language-server](https://github.com/theia-ide/typescript-language-server)                | [oxlint](https://github.com/oxc-project/oxc)    | [prettier](https://prettier.io)                              | [node](https://github.com/microsoft/vscode-js-debug)                                                                               |
...
| lisp             | ✓       | None                                                                                                 | None                                            | [ros](https://github.com/roswell/roswell)                    | None                                                                                                                               |
...
| markdown         | ✓       | [marksman](https://github.com/artempyanykh/marksman)                                                 | None                                            | None                                                         | None                                                                                                                               |
...
| objective-cpp    | ✓       | [clangd](https://clangd.llvm.org/)                                                                   | None                                            | [clang-format](https://clang.llvm.org/docs/ClangFormat.html) | None                                                                                                                               |
...
| racket           | ✓       | [racket-langserver](https://github.com/jeapostrophe/racket-langserver)                               | None                                            | None                                                         | None                                                                                                                               |
...
| typescript       | ✓       | [typescript-language-server](https://github.com/theia-ide/typescript-language-server)                | [oxlint](https://github.com/oxc-project/oxc)    | [prettier](https://prettier.io)                              | [node](https://github.com/microsoft/vscode-js-debug)                                                                               |
| typescriptreact  | ✓       | [typescript-language-server](https://github.com/theia-ide/typescript-language-server)                | None                                            | None                                                         | None                                                                                                                               |
| typst            | ✓       | [Tinymist](https://github.com/Myriad-Dreamin/tinymist)                                               | None                                            | None                                                         | None                                                                                                                               |
...
| ü               | ✓       | [Ü language server](https://github.com/Panzerschrek/U-00DC-Sprache)                                 | None                                            | None                                                         | [gdb](https://www.gnu.org/software/gdb) / [lldb-dap](https://github.com/llvm/llvm-project/blob/main/lldb/tools/lldb-dap/README.md) |
