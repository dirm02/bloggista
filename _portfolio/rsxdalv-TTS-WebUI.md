...
<div align="center">
  ...
  [![banner](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/rsxdalv-TTS-WebUI/documentation/screenshots/banner.png)](https://github.com/rsxdalv/tts-webui)
...
| ![react_1](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/rsxdalv-TTS-WebUI/documentation/screenshots/react_ui%20(1).png) | ![react_2](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/rsxdalv-TTS-WebUI/documentation/screenshots/react_ui%20(2).png) | ![react_3](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/rsxdalv-TTS-WebUI/documentation/screenshots/react_ui%20(3).png) |
| :-----------------------------------------: | :-----------------------------------------: | :-------------------------------: |

| ![gradio_1](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/rsxdalv-TTS-WebUI/documentation/screenshots/gradio%20(1).png) | ![gradio_2](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/rsxdalv-TTS-WebUI/documentation/screenshots/gradio%20(2).png) | ![gradio_3](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/rsxdalv-TTS-WebUI/documentation/screenshots/gradio%20(3).png) |
| :-----------------------------------------: | :-----------------------------------------: | :-------------------------------: |
...
![mini-control-panel](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/rsxdalv-TTS-WebUI/documentation/screenshots/mini-control-panel.png)
...
3. Once you can see the audio generates successfully, go to Silly Tavern, and add a new TTS API
   ...
   ![silly-tavern-tts-api](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/rsxdalv-TTS-WebUI/documentation/screenshots/silly-tavern-tts-api.png)
4. Test it out!
...
2. Start the API and test it with Python Requests
3. Configure using the panel: ![oobaboooga-text-to-tts-webui](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/rsxdalv-TTS-WebUI/documentation/screenshots/oobaboooga-text-to-tts-webui.png)
...
3. Once you can see the audio generates successfully, go to OpenWebUI, and add a new TTS API
   Default provider endpoint: `http://localhost:7778/v1/audio/speech`
4. Test it out!
![openwebui](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/rsxdalv-TTS-WebUI/documentation/screenshots/openwebui.png)
