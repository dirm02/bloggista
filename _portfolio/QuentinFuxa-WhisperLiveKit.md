...
| `--custom-alignment-heads` | Use your own alignment heads, useful when `--model-dir` is used. Use `scripts/determine_alignment_heads.py` to extract them. <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/QuentinFuxa-WhisperLiveKit/scripts/alignment_heads.png" alt="WhisperLiveKit Demo" width="300">
 | `None` |
