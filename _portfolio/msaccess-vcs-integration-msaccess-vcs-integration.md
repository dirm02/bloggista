...
1. Right click anywhere on the ribbon, click `customize ribbon`.
    ![rightClickRibbon](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/msaccess-vcs-integration-msaccess-vcs-integration/Assets/rightClickRibbon.png)
2. Then click on `Import/Export` then click `import customization file` and open `./UIRibbon/FORM UPDATES.exportedUI`.
    ![importCustomizationFile](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/msaccess-vcs-integration-msaccess-vcs-integration/Assets/importCustomizationFile.png)
