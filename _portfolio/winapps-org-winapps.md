...
<p align="center"><img align="center" width="700" src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/winapps-org-winapps/docs/readme/banner_light.svg#gh-light-mode-only"/></p>
<hr>
...
<p align="center"><img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/winapps-org-winapps/docs/readme/demo.png" width=1000 alt="WinApps Demonstration."></p>
...
<table cellpadding="10" cellspacing="0" border="0">
    <tr>
        <!-- Adobe Acrobat Pro -->
        <td>
            <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/winapps-org-winapps/apps/acrobat-x-pro/icon.svg" width="100">
        </td>
        <td>
        ...
        <!-- Adobe After Effects -->
        <td>
            <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/winapps-org-winapps/apps/aftereffects-cc/icon.svg" width="100">
        </td>
        <td>
    ...
    <tr>
        <!-- Adobe Audition -->
        <td>
            <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/winapps-org-winapps/apps/audition-cc/icon.svg" width="100">
        </td>
        <td>
        ...
        <!-- Adobe Bridge -->
        <td>
            <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/winapps-org-winapps/apps/bridge-cs6/icon.svg" width="100">
        </td>
        <td>
            <b>Adobe Bridge</b><br>
            (CS6, CC)<br>
    ...
    <tr>
        ...
        <td>
            <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/winapps-org-winapps/apps/adobe-cc/icon.svg" width="100">
        </td>
        <td>
        ...
        <!-- Adobe Illustrator -->
        <td>
            <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/winapps-org-winapps/apps/illustrator-cc/icon.svg" width="100">
        </td>
        <td>
    ...
    <tr>
        <!-- Adobe InDesign -->
        <td>
            <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/winapps-org-winapps/apps/indesign-cc/icon.svg" width="100">
        </td>
        <td>
        ...
        <!-- Adobe Lightroom -->
        <td>
            <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/winapps-org-winapps/apps/lightroom-cc/icon.svg" width="100">
        </td>
        <td>
    ...
    <tr>
        <!-- Adobe Photoshop -->
        <td>
            <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/winapps-org-winapps/apps/photoshop-cc/icon.svg" width="100">
        </td>
        <td>
        ...
        <!-- Affinity Designer 2 -->
        <td>
            <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/winapps-org-winapps/apps/afdesign/icon.svg" width="100">
        </td>
        <td>
    ...
    <tr>
        <!-- Affinity Photo 2 -->
        <td>
            <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/winapps-org-winapps/apps/afphoto/icon.svg" width="100">
        </td>
        <td>
        ...
        <td>
            <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/winapps-org-winapps/apps/afpub/icon.svg" width="100">
        </td>
        <td>
        ...
        <td>
            <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/winapps-org-winapps/apps/affinity/icon.svg" width="100">
        </td>
            <td>
        ...
        <!-- Command Prompt -->
        <td>
            <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/winapps-org-winapps/apps/cmd/icon.svg" width="100">
        </td>
        <td>
    ...
    <tr>
        <!-- File Explorer -->
        <td>
            <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/winapps-org-winapps/apps/explorer/icon.svg" width="100">
        </td>
        <td>
        ...
        <!-- Internet Explorer -->
        <td>
            <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/winapps-org-winapps/apps/iexplorer/icon.svg" width="100">
        </td>
        <td>
    ...
    <tr>
         <!-- Microsoft Access -->
        <td>
            <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/winapps-org-winapps/apps/access/icon.svg" width="100">
        </td>
        <td>
        ...
        <!-- Microsoft Excel -->
        <td>
            <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/winapps-org-winapps/apps/excel/icon.svg" width="100">
        </td>
        <td>
    ...
    <tr>
        <!-- Microsoft Word -->
        <td>
            <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/winapps-org-winapps/apps/word/icon.svg" width="100">
        </td>
        <td>
        ...
        <!-- Microsoft OneNote -->
        <td>
            <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/winapps-org-winapps/apps/onenote/icon.svg" width="100">
        </td>
        <td>
    ...
    <tr>
        <!-- Microsoft Outlook -->
        <td>
            <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/winapps-org-winapps/apps/outlook/icon.svg" width="100">
        </td>
        <td>
        ...
        <td>
            <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/winapps-org-winapps/apps/powerpoint/icon.svg" width="100">
        </td>
        <td>
    ...
    <tr>
        <!-- Microsoft Publisher -->
        <td>
            <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/winapps-org-winapps/apps/publisher/icon.svg" width="100">
        </td>
        <td>
        ...
        <!-- Microsoft Visio -->
        <td>
            <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/winapps-org-winapps/apps/visio/icon.svg" width="100">
        </td>
        <td>
    ...
    <tr>
        <!-- Microsoft Project -->
        <td>
            <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/winapps-org-winapps/apps/project/icon.svg" width="100">
        </td>
        <td>
        ...
        <td>
            <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/winapps-org-winapps/apps/visual-studio-pro/icon.svg" width="100">
        </td>
        <td>
    ...
    <tr>
        <!-- Autodesk Fusion 360 -->
        <td>
            <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/winapps-org-winapps/apps/fusion-360/icon.svg" width="100">
        </td>
        <td>
        ...
        <!-- mIRC -->
        <td>
            <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/winapps-org-winapps/apps/mirc/icon.svg" width="100">
        </td>
        <td>
            <b>mIRC</b><br>
    ...
    <tr>
        <!-- PowerShell -->
        <td>
            <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/winapps-org-winapps/apps/powershell/icon.svg" width="100">
        </td>
        <td>
            <b>PowerShell</b><br>
        ...
        <!-- Windows -->
        <td>
            <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/winapps-org-winapps/install/windows.svg" width="100">
        </td>
        <td>
            <b>Windows</b><br>
            (Full RDP Session)<br>
...
<img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/winapps-org-winapps/docs/readme/installer.gif" width=1000 alt="WinApps Installer Animation.">
...
<img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/winapps-org-winapps/docs/readme/launcher.gif" width=1000 alt="WinApps Launcher Animation.">
