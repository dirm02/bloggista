...
<div align="center">
  <picture>
    ...
    />
    <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/HenestrosaDev-audiotext/docs/light/icon.png" alt="Logo" width="128" height="128">
  </picture>
...
![Main](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/HenestrosaDev-audiotext/docs/main-system.png)
...
<details>
  ...
  <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/HenestrosaDev-audiotext/docs/dark/from-file.png" alt="Dark theme">
</details>

<details>
  <summary>Light</summary>
  <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/HenestrosaDev-audiotext/docs/light/from-file.png" alt="Light theme">
</details>
...
<picture>
  ...
  />
  <img
    src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/HenestrosaDev-audiotext/docs/light/main.png"
    alt="Main"
  >
</picture>
...
- **File** (see image above): Click the file explorer icon to select the file you want to transcribe, or manually enter the path to the file in the `Path` input field. You can transcribe audio from both audio and video files.
  ...
  ![File explorer](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/HenestrosaDev-audiotext/docs/file-explorer.png)

  ![Supported files](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/HenestrosaDev-audiotext/docs/supported-files.png)
...
- **Directory**: Click the file explorer icon to select the directory containing the files you want to transcribe, or manually enter the path to the directory in the `Path` input field. Note that the `Autosave` option is checked and cannot be unchecked because each file's transcription will automatically be saved in the same path as the source file.
  ...
  <picture>
    ...
    />
    <img
      src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/HenestrosaDev-audiotext/docs/light/from-directory.png"
      alt="Main"
    >
  </picture>
...
- **YouTube video**: Requires an Internet connection to get the audio of the video. To generate the transcription, simply enter the URL of the video in the `YouTube video URL` field and click the `Generate transcription` button when you are finished adjusting the settings.
  ...
  <picture>
    ...
    />
    <img
      src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/HenestrosaDev-audiotext/docs/light/from-youtube.png"
      alt="From microphone"
    >
  </picture>
...
<p align="center">
  <picture>
    ...
    <source
      ...
      media="(prefers-color-scheme: dark)"
    />
    <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/HenestrosaDev-audiotext/docs/light/google-api-options.png" alt="google-api-options">
  </picture>
</p>
...
<p align="center">
  <picture>
    ...
    <source
      ...
      media="(prefers-color-scheme: dark)"
    />
    <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/HenestrosaDev-audiotext/docs/light/google-api-key-dialog.png" alt="Google API key dialog">
  </picture>
</p>
...
<p align="center">
  <picture>
    ...
    <source
      ...
      media="(prefers-color-scheme: dark)"
    />
    <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/HenestrosaDev-audiotext/docs/light/whisper-api-options.png" alt="Whisper API options">
  </picture>
</p>
...
<p align="center">
  <picture>
    ...
    <source
      ...
      media="(prefers-color-scheme: dark)"
    />
    <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/HenestrosaDev-audiotext/docs/light/open-ai-api-key-dialog.png" alt="OpenAI API key dialog">
  </picture>
</p>
...
<p align="center">
  <picture>
    ...
    />
    <img
      src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/HenestrosaDev-audiotext/docs/light/whisperx-options.png"
...
<p align="center">
  <picture>
    ...
    />
    <img
      src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/HenestrosaDev-audiotext/docs/light/subtitle-options.png"
...
<p align="center">
  <picture>
    ...
    <source
      ...
      media="(prefers-color-scheme: dark)"
    />
    <img src="https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/HenestrosaDev-audiotext/docs/light/whisperx-advanced-options.png" alt="WhisperX advanced options">
  </picture>
</p>
