...
![Logo banner of the ESP32 Bus Pirate firmware](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/geo-tp-ESP32-Bus-Pirate/images/logo_protocols_banner_small.png)
...
![Demo showing the different mode of the ESP32 Bus Pirate firmware](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/geo-tp-ESP32-Bus-Pirate/images/help.gif)
![Demo showing the LittleFS file system of the ESP32 Bus Pirate firmware](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/geo-tp-ESP32-Bus-Pirate/images/littlefs.gif)
...
| Device               |                                     | Description                       |
|-----------------------|------------------------------------------|---------------------------------------------------|
| **ESP32 S3 Dev Kit**  | ![Photo of the ESP32 S3 Dev Kit](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/geo-tp-ESP32-Bus-Pirate/images/s3-devkit_s.jpg)     | More than 20 available GPIO, 1 button |
| **M5 Cardputer**      | ![Photo of the M5 Cardputer](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/geo-tp-ESP32-Bus-Pirate/images/cardputer_s.png)            | 2 GPIO (Grove), screen, keyboard, mic, speaker, IR TX, SD card, battery, [standalone mode](#standalone-mode-for-the-cardputer)            |
| **M5 Cardputer ADV**  | ![Photo of the M5 Cardputer ADV](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/geo-tp-ESP32-Bus-Pirate/images/cardputer-adv_s.jpg)    | 12 GPIO (Grove, Header), screen, keyboard, mic, speaker, IR TX, SD card, IMU, battery, [standalone mode](#standalone-mode-for-the-cardputer)                  |
| **M5 Stick S3** | ![Photo of the M5 Stick S3](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/geo-tp-ESP32-Bus-Pirate/images/m5sticks3_s.jpg)      | 13 GPIO (Grove, Header), screen, mic, speaker, IR TX, IR RX, IMU, 3 buttons, battery                 |
| **M5 StampS3**        | ![Photo of the M5 StampS3](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/geo-tp-ESP32-Bus-Pirate/images/stamps3_s.jpg)             | 9 GPIO (exposed pins), 1 button                       |
| **M5 AtomS3 Lite**    | ![Photo of the M5 Atom S3 Lite](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/geo-tp-ESP32-Bus-Pirate/images/atom_s.jpg)            | 8 GPIO (Grove, Header), IR TX, 1 buttton                  |
| **LILYGO T-Embed**    | ![Photo of the LILYGO T-Embed](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/geo-tp-ESP32-Bus-Pirate/images/tembed_s.jpg)          | 9 GPIO (Grove, Header), screen, encoder, speaker, mic, SD card                                         |
| **LILYGO T-Embed CC1101** | ![Photo of the LILYGO T-Embed CC1101](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/geo-tp-ESP32-Bus-Pirate/images/tembedcc1101_s.jpg) | 4 GPIO (2x Qwiic), screen, encoder, speaker, mic, SD Card, CC1101, PN532, IR TX, IR RX , battery                                 |
| **Seeed Studio Xiao S3** | ![Photo of the Seeed Studio Xiao ESP32-S3](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/geo-tp-ESP32-Bus-Pirate/images/xiaos3_s.jpg)        | 9 GPIO (exposed pins), 1 button        
...
[![Banner of the ESP32 Bus Pirate web flasher](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/geo-tp-ESP32-Bus-Pirate/images/flasher.jpg)](https://geo-tp.github.io/ESP32-Bus-Pirate/webflasher/)
...
[![Banner of the ESP32 Bus Pirate Wiki page](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/geo-tp-ESP32-Bus-Pirate/images/bus_pirate_wiki.png)](https://github.com/geo-tp/ESP32-Bus-Pirate/wiki/)
...
[![Banner of the ESP32 Bus Pirate Scripts page](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/geo-tp-ESP32-Bus-Pirate/images/bus_pirate_scripts.png)](https://github.com/geo-tp/ESP32-Bus-Pirate-Scripts/)
...
![A photo of the ESP32 Bus Pirate firmware running on M5 Stack devices](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/geo-tp-ESP32-Bus-Pirate/images/m5buspirate_s.jpg)

## ESP32 Bus Pirate on T-Embed
![A photo of the ESP32 Bus Pirate firmware running on Lilygo device](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/geo-tp-ESP32-Bus-Pirate/images/tembedbuspirate_s.jpg)
...
![An iPhone screenshot showing the Bus Pirate firmware web interface](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/geo-tp-ESP32-Bus-Pirate/images/presentation_mobile.png)

## Standalone Mode for the Cardputer
![A Cardputer running the ESP32 Bus pirate in standalone mode](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/geo-tp-ESP32-Bus-Pirate/images/standalonemode_s.png)

## Using the ESP32 Bus Pirate to speak UART over WiFi
![A demo Using the ESP32 Bus pirate firmware with UART](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/geo-tp-ESP32-Bus-Pirate/images/demo2.gif)
...
#### [![Small logo of the ESP32 Bus Pirate firmware](https://raw.githubusercontent.com/dirm02/mystars/master/starred-readmes/geo-tp-ESP32-Bus-Pirate/images/logo_square_small.png)](https://github.com/geo-tp/ESP32-Bus-Pirate/wiki/99-Visual-Assets)
